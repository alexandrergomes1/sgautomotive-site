...
import { FadeUp, SlideIn, AnimateItem } from "@/components/ui/animate";
  ...
  return (
    <section className="py-16 md:py-24 bg-surface border-y border-border" id="importacao">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <FadeUp className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full border border-accent/30 bg-accent/5 text-accent text-xs font-medium tracking-widest uppercase mb-6">
          {t("badge")}
        </FadeUp>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-start">
          ...
          <div className="flex flex-col gap-5">
            {steps.map((step, i) => (
              <AnimateItem key={step.number} delay={i * 0.1}>
                <div className="flex gap-5 p-5 bg-bg border border-border rounded-xl hover:border-accent/30 transition-colors">
