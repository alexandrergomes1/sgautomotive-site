...
function heroAnim(delayMs: number): { style: React.CSSProperties } {
  return {
    style: {
      animation: "fade-up-hero 0.55s ease-out both",
    ...
    >
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24">
        <div className="max-w-4xl">
          ...
          {/* CTAs */}
          <div {...heroAnim(360)} className="flex flex-col sm:flex-row gap-3 mb-16">
            <a
              href="#veiculos"
